...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    name: 'CircleMembers',
    component: () => import('@/views/circle/CircleMembersPage.vue'),
    meta: { requiresAuth: true, transition: 'slide-in-right', title: '成员管理' }
  },
  {
    path: '/circle/:id/edit',
    name: 'EditCircle',
  ...
  },
  {
    ...
    meta: { requiresAuth: true, transition: 'scale-in', title: '创建圈子' }
  },
  {
    path: '/messages',
    name: 'Messages',
